...
$sql2="SELECT author FROM post WHERE post_id={$post_id}"; //get particular author id from post
$result2=mysqli_query($conn,$sql2) or die("Query failed ");
$row2=mysqli_fetch_assoc($result2);

if($row2['author'] != $_SESSION["user_id"]){  //means normal user admin wale user ki post access krne ki kosish kr raha hai is liye ye if condition run hogi
